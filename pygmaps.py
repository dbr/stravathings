...
## http://code.google.com/p/pygmaps/source/browse/trunk/pygmaps.py
############################################################
...
class maps:
    ...
    def draw(self, htmlfile, extrahtml = None):
        f = open(htmlfile,'w')
        f.write('<html>\n')
        f.write('<head>\n')
    ...
    def drawPolyline(self,f,path,\
        ...
        #dbr: added
        f.write("for(var i in PolylineCoordinates){ bounds.extend(PolylineCoordinates[i]) };")
